...
struct tests
{
	...
	static void blockchain_full_coverage(vector<account_ref>* userdata)
	{
		tester::use_clean_state([&]()
		{
			...
			TEST_BLOCK(&generators::route_stage_2, "0x0a3681920d92d035d470819e23001439b18dd3a031505b31f9d4205a1add6150", 5);
			TEST_BLOCK(&generators::attestate_stage_1, "0xfbd82c1c7f119cbba118c0f3b46eb7187c3840ff51995224fb3872a51177403d", 7);
			TEST_BLOCK(&generators::transfer_stage_1, "0x5c09d9961b3505af44532053bd956f542a6e04d476ca1a21fffc1bef69263df1", 8);
			TEST_BLOCK(&generators::transfer_stage_2, "0xdc6b7e2f31bba7b4b226f6d106f9cb1455d8998be13980251081e46deab2dbc7", 9);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("BTC"), users[2].wallet.get_address(), 0.05), "0xb753ce0c9d3c856fbb8bee6ac7000957cd2b01c7ec311ecffd20de78ecbffe73", 10);
			TEST_BLOCK(std::bind(&generators::deploy_stage_1, std::placeholders::_1, std::placeholders::_2, &contracts), "0xd0207137d9d0ad8615a8b7870daf6b018a62aaa6c492ffe442a57961d2e6b808", 11);
			TEST_BLOCK(std::bind(&generators::deploy_stage_2, std::placeholders::_1, std::placeholders::_2, &contracts), "0x68d4b6ece0abc90d9952c7c1d0218b5a5ceab741073cdc6ec29894dd6f4f0b2b", 12);
