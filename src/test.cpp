...
struct tests
{
	...
	static void blockchain_full_coverage(vector<account_ref>* userdata)
	{
		tester::use_clean_state([&]()
		{
			...
			TEST_BLOCK(&generators::route_stage_2, "0x8fa93d727ef7abe59be7e3c18c1fd7427e6ca92a0e5de28503328e90fcb301d4", 5);
			TEST_BLOCK(&generators::attestate_stage_1, "0xecdfdd2809adc7b584bb5902ffdc72d1ebd40dc9aacde5b37e83983e81fc7cdc", 7);
			TEST_BLOCK(&generators::transfer_stage_1, "0x177ca8c5027ccc9b2e5328e92dd28327a394ace519b38479646bc45f42b379f4", 8);
			TEST_BLOCK(&generators::transfer_stage_2, "0x17571819c1e0ce21d767e24887403d070d16690fcddc27f779b5c332084891d5", 9);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("BTC"), users[2].wallet.get_address(), 0.05), "0x389e5a92caf5ba742213f614305c7f485b88372331a2f8f2058b9904179a5a78", 10);
			TEST_BLOCK(std::bind(&generators::deploy_stage_1, std::placeholders::_1, std::placeholders::_2, &contracts), "0x227a64715bf23028610f90d19e32edc0d2b14466db0a1aa8c90ba1a741d1282d", 11);
			TEST_BLOCK(std::bind(&generators::deploy_stage_2, std::placeholders::_1, std::placeholders::_2, &contracts), "0x02c17c26f42c79d087abfd058a17cd3e9e3060d99fc78c7d678d7251366ee4c2", 12);
			TEST_BLOCK(std::bind(&generators::call_stage_1, std::placeholders::_1, std::placeholders::_2, &contracts), "0x21995f5effa8eb734724cff3d9a660a667379bef5ec4bf60377ace2c7fd1c665", 13);
			TEST_BLOCK(&generators::rollup_stage_1, "0x535aeac379bd91e30314799f6a83c58d6b094f48e9c494b4934ed323a46bbabc", 14);
			TEST_BLOCK(std::bind(&generators::setup_custom, std::placeholders::_1, std::placeholders::_2, 2, 0, 1), "0x4ad9192f65045ba74e0927058840cf9e3b8d6de9543cbca3f857c6cad67107ed", 15);
			TEST_BLOCK_FAULT(&generators::migrate_stage_1, "0x5ba06792a5533c7d4473b25a8719b46253fd3e617da1b4e4b7b0841006aaf1a8", 16);
			TEST_BLOCK(&generators::migrate_stage_2, "0xf23aedb25ece8d16062a1c57d3c031fb9d921843af7ed436ba0cdf7ffaca252c", 18);
			TEST_BLOCK(&generators::migrate_stage_3, "0x4ed352c091b998f686d36a0c9b7102ee2196efe68083811d0a34168fc0360d33", 19);
			TEST_BLOCK(&generators::migrate_stage_4, "0xd7539a2f257ccc72192768890d728fcdd83db588c759d280886b5a255f1462fb", 21);
			TEST_BLOCK(&generators::withdraw_stage_1, "0xb369858bd9f6f9534f7e2cecb2b1591a5ed39b4dbabaf3cdb17dc887543092ed", 23);
			TEST_BLOCK(&generators::withdraw_stage_2, "0xc7cabab96fa1e74828c15f6bb96f799cb48e1b494314c564bb77058765b6d00b", 25);
			TEST_BLOCK(&generators::withdraw_stage_3, "0x5b87e5899858cd203fc4996a1b38b42c59895c25d2d24dffc4d4dba94d181373", 26);
			TEST_BLOCK(&generators::withdraw_stage_4, "0x963b93823d46d9931b0753c3b40a05b2ec253a51ed659f2459091e46811b9141", 27);
			TEST_BLOCK(&generators::withdraw_stage_5, "0xe0e3ab36be4a8d5876142336510dc9415dd10f7eeaa5556c10dad3591b5d5d0d", 28);
			TEST_BLOCK(&generators::withdraw_stage_6, "0xc5de35bfd2bda88e62b115267979cd19b1f238b05ab0de73650191bf0d4142ea", 30);
			TEST_BLOCK(&generators::withdraw_stage_7, "0xba6331e2431f9c530f2421d9f3f5b5c7236d3fb8a87b62f017399cbfab806711", 32);
			TEST_BLOCK(std::bind(&generators::setup_custom, std::placeholders::_1, std::placeholders::_2, 2, 1, 0), "0x66e6d6c9ec48960ce33c1a63b87f71524503bceecc79c3c21768dccdda8ccc9a", 34);
			if (userdata != nullptr)
	...
	static void blockchain_partial_coverage(vector<account_ref>* userdata)
	{
		tester::use_clean_state([&]()
		{
			...
			TEST_BLOCK(&generators::attestate_stage_0, "0x620fb5112f8963d013f866322109d3fce7bd52d1254f3f974c7f96a3ee73cc78", 4);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("BTC"), "tcrt1x00g22stp0qcprrxra7x2pz2au33armtfc50460", 5), "0x675095af35e5432159c8fd109b5c34f325b442e9f8702c84c06e147a968a4fd8", 5);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("ETH", "tBTC", "0x18084fbA666a33d37592fA2633fD49a74DD93a88"), "tcrt1x00g22stp0qcprrxra7x2pz2au33armtfc50460", 5), "0xe336ac272c95aa176c5db351f7d2ee23de0a31fb09b9fa0c94a7518d51fc7c34", 6);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("ETH", "USDT", "0xdAC17F958D2ee523a2206206994597C13D831ec7"), "tcrt1x00g22stp0qcprrxra7x2pz2au33armtfc50460", 300000), "0x62fd55f3b71b599787fc176a73b54dde365f32011cababe41dc65228bf2d10a8", 7);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("TRX", "USDT", "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t"), "tcrt1x00g22stp0qcprrxra7x2pz2au33armtfc50460", 200000), "0x514e68c5c67274d9564ac658e0c063f3ebf8c58fbc8b160e78d57a64b29d4958", 8);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("BTC"), "tcrt1xu0k7jd2hsv2x5h80tcslpk3n0kvzzw5kup6vng", 5), "0xd6dc6c4a1a8d196e563508c129a9c4f63d61798804628be3ffb83abe421f1251", 9);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("ETH", "tBTC", "0x18084fbA666a33d37592fA2633fD49a74DD93a88"), "tcrt1xu0k7jd2hsv2x5h80tcslpk3n0kvzzw5kup6vng", 5), "0x1d0a25073f44b194d0c808df429bb07a8685a049099798535200a42973064000", 10);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("ETH", "USDT", "0xdAC17F958D2ee523a2206206994597C13D831ec7"), "tcrt1xu0k7jd2hsv2x5h80tcslpk3n0kvzzw5kup6vng", 300000), "0x2a405d9b4cad57d7d025fbe4269ea2c7e582b60605da89a6510861f564dc53e0", 11);
			TEST_BLOCK(std::bind(&generators::transfer_custom, std::placeholders::_1, std::placeholders::_2, 0, algorithm::asset::id_of("TRX", "USDT", "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t"), "tcrt1xu0k7jd2hsv2x5h80tcslpk3n0kvzzw5kup6vng", 200000), "0x0c915640f889f92372403542ac2fe876bd93b770dfb8a22e4a249cd8ad897c76", 12);
			if (userdata != nullptr)
				*userdata = std::move(users);
			else
				console::get()->write_line(data->as_json(true));
