...
struct tests
{
	...
	static void blockchain_full_coverage(vector<account_ref>* userdata)
	{
		tester::use_clean_state([&]()
		{
			...
			TEST_BLOCK(std::bind(&generators::deploy_stage_1, std::placeholders::_1, std::placeholders::_2, &contracts), "0x5deb67667615c50e3af2a5fbe4d765c2745744544235f09a322b5db2584b2e9c", 11);
			TEST_BLOCK(std::bind(&generators::deploy_stage_2, std::placeholders::_1, std::placeholders::_2, &contracts), "0xedc174b0c551fb81689b7849426e66cbbecc8fadcd42804bcfee529a9c2b9d61", 12);
			TEST_BLOCK(std::bind(&generators::call_stage_1, std::placeholders::_1, std::placeholders::_2, &contracts), "0xb94907b870c4e5cf92247084402a77f21a6a8dd27c8d38885b78b7e5ce5a497c", 13);
			TEST_BLOCK(&generators::rollup_stage_1, "0x21b6faf4834e9c35e2c08669b72cbaefc398656cfaf7c3e017331112b9df6a9e", 14);
			TEST_BLOCK(std::bind(&generators::setup_custom, std::placeholders::_1, std::placeholders::_2, 2, 0, 1), "0xe177c12e6a2aa40b5b36bad6b60acbac6acde7dd98fd15a98a2be91353fe3411", 15);
			TEST_BLOCK_FAULTY(&generators::migrate_stage_1, "0x6a983d88ad268d2a9c36c6a8666bd307b4fed2b34ee61eb189119e947afae5d3", 16);
			TEST_BLOCK(&generators::migrate_stage_2, "0x6d84f8df442ac8fc6f593549ed75a1f04f4f5c43c4d9de1a337f16bc3297d810", 18);
			TEST_BLOCK(&generators::migrate_stage_3, "0x918dec9ac70f795588d7abdcecae8589683f2947e057dd5174661a89f264c192", 19);
			TEST_BLOCK(&generators::migrate_stage_4, "0xe679647002a3e4ddf51b4f32ce92be1ec52b2f55132ca9d765d5eafa876d7072", 21);
			TEST_BLOCK(&generators::withdraw_stage_1, "0x5c550572621c04a0c0e60c46bc2f41a57ff59cd8233b9bbd0e8ed464e862a5c8", 23);
			TEST_BLOCK(&generators::withdraw_stage_2, "0xf4a2cfcc1bfd69dc833851053ed43a8bd622cbabb5daa3dfe81745def31ec597", 25);
			TEST_BLOCK(&generators::withdraw_stage_3, "0xed501d47551f0f88b76df625a18d13a11b505fe75b8aae0755cc4592b10f60e7", 26);
			TEST_BLOCK(&generators::withdraw_stage_4, "0x8f5c1a5a94e0e5933b8586a468bc0b0c94cd72a3011e9da44d136ef74e5eeb6a", 27);
			TEST_BLOCK(&generators::withdraw_stage_5, "0xc9af158ef1b0a4de456512827a7b403b7e2e1aee3e233dc9538c85840c2165aa", 28);
			TEST_BLOCK(&generators::withdraw_stage_6, "0x03bbce749ce1a88b6e585f77b6fdafd4e3a68d2c433c633bf8ae475af69a6ecd", 30);
			TEST_BLOCK(&generators::withdraw_stage_7, "0xe3ec55a4d837f7ade86b8c1400e59c2c3b1f7d98eaba9fb4118165687a918450", 32);
			TEST_BLOCK(std::bind(&generators::setup_custom, std::placeholders::_1, std::placeholders::_2, 2, 1, 0), "0x1ac705343b46600452a06536d9961f5120800b93414005b78b84b5063088b80e", 34);
			TEST_BLOCK_FALLBACK(&generators::production_stage_1, "0x73c4772fc6849e7a522fe9707fd530408c3e71d3de1175afc7e379e42bbad76c", 35);
			TEST_BLOCK(&generators::production_stage_2, "0x76a73ef3d54f5d345eda016a9bc8738a908e05ef0d4618fefa8b33adb288cd83", 36);
			if (userdata != nullptr)
