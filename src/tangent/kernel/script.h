...
namespace tangent
{
	namespace ledger
	{
		...
		struct script_program
		{
			...
			virtual decimal depository_incoming_reward_of(const script_address& target, const algorithm::asset_id& asset, const decimal& value) const;
			virtual decimal depository_outgoing_reward_of(const script_address& target, const algorithm::asset_id& asset, const decimal& value) const;
			virtual uint64_t depository_policy_of(const script_address& target, const algorithm::asset_id& asset) const;
			virtual decimal depository_balance_of(const script_address& target, const algorithm::asset_id& asset) const;
			...
			virtual script_address witness_address_of(const algorithm::asset_id& asset, const std::string_view& address, size_t offset) const;
