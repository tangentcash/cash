...
namespace Tangent
{
	namespace Mediator
	{
		namespace Backends
		{
			class Stellar : public RelayBackend
			{
			public:
			...
			public:
				virtual ExpectsPromiseRT<AssetInfo> GetAssetInfo(const Algorithm::AssetId& Asset, const std::string_view& Address, const std::string_view& Code);
				virtual ExpectsPromiseRT<AccountInfo> GetAccountInfo(const Algorithm::AssetId& Asset, const std::string_view& Address);
				virtual ExpectsPromiseRT<String> GetTransactionMemo(const Algorithm::AssetId& Asset, const std::string_view& TxId);
				virtual ExpectsPromiseRT<bool> IsAccountExists(const Algorithm::AssetId& Asset, const std::string_view& Address);
