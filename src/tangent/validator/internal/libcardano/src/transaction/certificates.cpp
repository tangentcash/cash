...
namespace Cardano{
/// Vector<uint8_t> redeemer_cert (redeeemer) :
...
void Certificates::addStakeRegistration(Cardano::Credential const ckey, uint8_t const *const stake_credential){
...
void Certificates::addStakeDeregistration(Cardano::Credential const ckey, uint8_t const *const stake_credential){
    // stake_credential_vk(28bytes)
    //crypto_generichash_blake2b(blake224, 28, stake_credential_vk, 32, nullptr, 0);
    cert_cbor.clearCbor();
    cert_cbor.createArray(2);                                                       // [ , ]
...
void Certificates::addStakeDelegation(Cardano::Credential const ckey, uint8_t const *const stake_credential, uint8_t const *const pool_keyhash){
...
void Certificates::addStakeDelegation(Cardano::Credential const ckey, uint8_t const *const stake_credential, std::string const & poolID_bech32){
