...
namespace tangent
{
	...
	namespace rpc
	{
		...
		private:
			...
			server_response chainstate_get_validator_production_with_rewards(http::connection* base, format::variables&& args);
			server_response chainstate_get_best_validator_producers(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_production_reward(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_production_rewards(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_participation(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_participation_with_rewards(http::connection* base, format::variables&& args);
			...
			server_response chainstate_get_validator_participation_reward(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_participation_rewards(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_participation_ref(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_participation_refs(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_attestation(http::connection* base, format::variables&& args);
			server_response chainstate_get_validator_attestation_with_rewards(http::connection* base, format::variables&& args);
			...
			server_response mempoolstate_simulate_bridge(http::connection* base, format::variables&& args);
			...
			server_response validatorstate_pruned_status(http::connection* base, format::variables&& args);
			server_response validatorstate_full_status(http::connection* base, format::variables&& args);
			server_response validatorstate_status(http::connection* base, format::variables&& args, bool pruned);
