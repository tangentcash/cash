...
namespace Tangent
{
	...
	namespace RPC
	{
		...
		private:
			...
			ServerResponse ChainstateGetAccountContribution(HTTP::Connection* Base, Format::Variables&& Args);
			ServerResponse ChainstateGetAccountContributions(HTTP::Connection* Base, Format::Variables&& Args);
			ServerResponse ChainstateGetBestAccountContributions(HTTP::Connection* Base, Format::Variables&& Args);
			ServerResponse ChainstateGetBestAccountContributionsWithRewards(HTTP::Connection* Base, Format::Variables&& Args);
