...
namespace Tangent
{
	uint32_t Types::TypeOf(const std::string_view& Name)
	{
		...
		static std::array<std::string_view, 47> Types =
		{
			{
				std::string_view("account_sequence"),
				std::string_view("account_work"),
				std::string_view("account_observer"),
				...
				std::string_view("address_account"),
				std::string_view("pubkey_account"),
				std::string_view("delegation_account"),
				std::string_view("custodian_account"),
