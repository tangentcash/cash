...
namespace tangent
{
	namespace compositions
	{
		...
		struct ed25519_compositor final : algorithm::composition::compositor
		{
			...
			expects_lr<void> tweak_secret_key(const algorithm::paillier_scalar_t& public_key, const algorithm::composition::cseckey_t& tweak, algorithm::composition::cseckey_t* secret_key_input_output, algorithm::paillier_scalar_t* accumulator_output) const override;
