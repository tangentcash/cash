...
int ed25519_scalar_add(const ed25519_secret_key sk1, const ed25519_secret_key sk2, ed25519_secret_key res);
int ed25519_point_add(const ed25519_public_key pk1, const ed25519_public_key pk2, ed25519_public_key res);
