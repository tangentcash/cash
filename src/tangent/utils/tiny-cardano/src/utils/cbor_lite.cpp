...
CborSerialize &CborSerialize::addNint_zero_equal_1(uint64_t number){ // toma un uint64_t y lo serializa como un numero negativo de 64bytes, considera 0 como -1
...
CborSerialize &CborSerialize::addNint_withoutzero(uint64_t number){ // toma un uint64_t y lo serializa como un numero negativo de 64bytes, se excluye el cero
